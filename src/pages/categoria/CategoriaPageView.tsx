...
type props ={
  ...
  idCategoriaAlterar: number;
  isOpenModelAlterarCategoria: boolean;
  fecharModelAlterarCategoria(): void;
}

export default function CategoriaPageView({
  formData,
  categorias,
  idCategoriaAlterar,
  isOpenModelAlterarCategoria,
  fecharModelAlterarCategoria,
  EditarForm,
  CriarCategoria,
  EditarCategoria,
  DeletarCategoria,
    ...
    return(
      <div className=" mb-1 ">
                ...
                categorias.map((categoria) => (
                  <tr key={categoria.id}>
                    <td style={{ width: "200px" }}>
                      <span className="badge text-write px-3 py-2"
                          style={{
                    ...
                    <td>
                      <button className="btn btn-sm  me-1" onClick={() => EditarCategoria(categoria.id) } >
                        <MdEdit size={"20px"}/>
                      </button>
                      <button className="btn btn-sm " onClick={() => DeletarCategoria(categoria.id)} >
        ...
        <CategoriaModal 
          idCategoria={idCategoriaAlterar}
          mostrar={isOpenModelAlterarCategoria}
          onFechar={fecharModelAlterarCategoria}
          />
      </div>
    )
}